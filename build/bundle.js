...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppComponent = __webpack_require__(163);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./productCSS.css", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./productCSS.css");
	...
	var ProductBox = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      'div',
	      { className: 'container' },
	      React.createElement(LoginForm, { data: this.state.data, onLoginSubmit: this.handleLoginSubmit, onRegisterSubmit: this.handleRegisterSubmit }),
	      React.createElement(
	        'p',
	        { className: 'tips' },
	        this.state.text
	  ...
	  render: function () {
	    if (this.state.data == 0) {
	      return React.createElement(
	        ...
	        React.createElement('input', { type: 'button', value: 'Register', onClick: this.handleRegister }),
	      ...
	      return React.createElement(
	        'form',
	        { className: 'registerForm', onSubmit: this.handleRegisterSubmit },
	        React.createElement(
	          'span',
	          null,
	          this.state.tittle
	        ...
	        React.createElement(
	          'span',
	          { className: 'changeLogin', onClick: this.handleLogin },
	          'Login'
	        ),
	        React.createElement('input', { type: 'text', placeholder: 'Your email username ', ref: 'username' }),
	        React.createElement('input', { type: 'text', placeholder: 'Your nick name', ref: 'nick' }),
	        React.createElement('input', { type: 'password', placeholder: 'Your password', ref: 'password' }),
